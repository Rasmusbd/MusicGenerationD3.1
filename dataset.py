...
class Dataset(torch.utils.data.Dataset):
    def __init__(self,
        ...
        if inputs is None:
            if length is None:
                ...
                inputs = [[]] * length
        self.inputs = inputs
        #self.data = [None for _ in inputs] /No cache since it will use way to much RAM
    ...
    def __getitem__(self, index):
        ...
        #self.data[index] = res //Removed this to not cache every image
    ...
    """
    def _should_replace(self, index): #Removing this aswell since we should always replace since no cache
